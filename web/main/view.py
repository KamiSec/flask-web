from flask import request, abort, current_app, render_template, flash, \
    send_from_directory,redirect, url_for, make_response
from . import main
from .. import db
from ..models import User,Role,Permission,Post,Comment
from ..decorators import admin_required
from .forms import EditProfileForm, EditPrifileAdminForm, PostForm, CommentForm
...
def edit_profile_admin(id):
    ...
    form = EditPrifileAdminForm(user=user)
    if form.validate_on_submit():
